...
<Required for adapters generated by /adapter-builder (v1.4+); hand-written adapters are grandfathered. The ordered, concrete steps a practitioner or a lesser model follows in this domain, each naming what to open, produce, or check, followed by a mermaid flowchart of them. This is the user-facing "how to work in this domain" artifact; it must be followable, not aspirational.>
