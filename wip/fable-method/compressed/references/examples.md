...
Each example shows core protocol applied end to end, with two steps weak models most often fake (Step 1 definition of done and Step 5 observed verification) spelled out concretely.

## 1. Trivial (gate, no core protocol)
...
If rename turned out to cross files (search shows 14 call sites in 6 files), gate fails retroactively: say so and enter full core protocol at Step 1 with checklist.
