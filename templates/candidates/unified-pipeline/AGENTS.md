...
- **Question/assessment:** every claim in the findings traces to something you read or ran; you can cite the file and line, or the command output, for each claim.
...
7. **Surprises route the loop.** Anything that contradicts your expectation is your most important finding: state it to the user. If it changes what done means, update Step 1. If it changes what the user is asking for, go back to Step 0. Otherwise report it and continue.
...
6. **Never destroy without looking.** Before deleting or overwriting anything, look at what is there. If it contradicts how it was described, stop and surface that.
