...
1. **Look at the raw data itself**, not its description: at least the header, a sample of rows, and the row count. Every real-world export is dirtier than described.
