...
1. **<The governing document or ground truth of this sector>**: <what must be opened, and what to do when it does not exist>.
...
- <3 to 5 bullets. Each one: what "observed" means for this sector's claims, checks that must be run or opened, exactness requirements (names, prices, dates, versions).>
- <Include the sector's equivalent of "rendered surfaces are rendered and looked at".>
