...
| 14 | **Verification theater** | "This should work now" with nothing run; or the target check passes while the build breaks | Step 5: observed verification, both halves (target + surrounding system) |
