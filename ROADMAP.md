...
Ownership, Checkpoint, EP v1 then Principles (0020) then v2 (0021), Eval Isolation, Behavior Corpus Outcome scorers. Vendor fable tree + `wip/` removed 2026-08-14.
