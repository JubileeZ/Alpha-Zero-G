# Distilled Think+Prove always-on; analyst domain skills
...
**History:** Originally shipped `azg-orchestrate` (Act, on-demand). Removed from repo/Device Setup until a real need; always-on Intent gates cover ordinary work.
