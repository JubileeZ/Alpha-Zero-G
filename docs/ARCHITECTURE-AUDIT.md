...
- Adopt / promote decisions use Trap Suite 3-arm Process Gate (baseline / current / candidate) with Docker Eval Isolation; SWE-bench Lite path removed (ADR 0007 superseded).
